...
const Header = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      path: "/inventory-management?tab=add-stock",
            ...
            {isMenuOpen && (
              <div className="absolute right-0 mt-3 w-72 bg-white rounded-lg shadow-xl z-10 overflow-hidden border border-gray-100 transform transition-all duration-200">
                ...
                <div className="px-4 py-2 bg-gray-50">
                  <button className="w-full text-center text-sm text-blue-600 hover:text-blue-800 font-medium py-1" onClick={() => setIsMenuOpen(false)}>
                    Close Menu
                  </button>
                </div>
              </div>
